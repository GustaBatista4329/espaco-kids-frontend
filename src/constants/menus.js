import { Home, UserPlus, Users, Baby, Clock, ClipboardList, Calendar, KeyRound, GraduationCap, FileText } from "lucide-react";
...
export const ADM_MENU = [
  ...
  { id: "banco-atividades", label: "Atividades", icon: FileText },
